...
using NLog.Common;
using NLog.Config;
using MLAB.PlayerEngagement.Infrastructure.Logging.Extensions;
using NLog.Extensions.Logging;

namespace MLAB.PlayerEngagement.Infrastructure.Logging;

public class NLogConfiguration : LoggingConfigurationParser
{
    private readonly Microsoft.Extensions.Configuration.IConfigurationSection _originalConfigSection;
    ...
    public NLogConfiguration(IConfigurationSection nlogConfig)
    ...
    public NLogConfiguration(IConfigurationSection nlogConfig, LogFactory logFactory)
        : base(logFactory)
    {
    ...
    {
        return new NLogConfiguration(_originalConfigSection, LogFactory);
    }
    ...
    private void ReloadConfigurationSection(IConfigurationSection nlogConfig)
    {
        try
        {
            ...
            var newConfig = new NLogConfiguration(nlogConfig, LogFactory);
